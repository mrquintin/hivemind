...
You can keep your RDS instance details (endpoint, username, password, and options) in a local file such as `deploy/aws/RDS-CREDENTIALS.local.txt`; that file is gitignored and must not be committed.
